...
static Item searchR(link h, SearchKey k, link z) { //NON si può cercare come si cercherebbe su un BST, perchè il criterio di ordinamento del bst non è lo stesso del campo che sto cercando!!!
  int cmp;
